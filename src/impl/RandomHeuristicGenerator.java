...
public class RandomHeuristicGenerator {
	...
	private HashMap<Integer, List<Double>> randomNumberMap = new HashMap<Integer, List<Double>>();

	public Double generateRandomHeuristic(Integer heuristicID, State state) {
	...
	private List<Double> getRandomNumbersForHeuristic(Integer id) {
